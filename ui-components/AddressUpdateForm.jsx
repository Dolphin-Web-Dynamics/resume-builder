...
export default function AddressUpdateForm(props) {
  ...
  const [street2, setStreet2] = React.useState(initialValues.street2);
  ...
  const resetStateValues = () => {
    ...
    setStreet2(cleanValues.street2);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getAddress.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAddress
        : addressModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateAddress.replaceAll("__typename", ""),
            variables: {
              input: {
                id: addressRecord.id,
                ...modelFields,
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.street2 ?? value;
          }
          if (errors.street2?.hasError) {
            runValidationTasks("street2", value);
          }
          setStreet2(value);
        }}
        onBlur={() => runValidationTasks("street2", street2)}
        errorMessage={errors.street2?.errorMessage}
        hasError={errors.street2?.hasError}
        {...getOverrideProps(overrides, "street2")}
      ></TextField>
      <TextField
        label="City"
        isRequired={false}
